...
### 2. 구조체, 포인터, 문자열
  ...
  - 배열 기반 자료구조와 포인터(연결리스트) 자료구조와의 차별성, 자기 참조 구조체
  - 문자열의 특징
...
### 3. 프로세스 기본 1
  ...
  - [비디오](https://www.youtube.com/watch?v=scBmmCWmr-Y)
### 4. 프로세스 기본 2 + 파이프 통신 기본
  ...
  - 프로세스 파이프 통신 기초
  - 프로세스 파이프 통신 실습
  - [비디오](https://www.youtube.com/watch?v=0IPOMDhB_sA)
### 5. 프로세스 기본 3 + 파이프 통신 실습
  - 프로세스 기본 간단 정리
  - 프로세스 fork, sleep, wait, pipe 종합 실습 문제
  - [비디오](https://www.youtube.com/watch?v=8e2N_qEAOlA)
### 6. 기본 파일 입출력 1 (C언어 기반)
  - [비디오](https://www.youtube.com/watch?v=8hGagIJ1xAQ)
### 7. 기본 파일 입출력 2 (C언어 기반)
  - [비디오](https://www.youtube.com/watch?v=ZUChCCS-X7k)
### 8. 시그널 및 프로세스 우선순위 기초 1
  - 시그널이 무엇인가?
  - 시그널이 발생하는 시기
  - 사용자 정의 시그널 관련 실습
  - [비디오](https://www.youtube.com/watch?v=TtouwUjDCkU)
### 9. 시그널 및 프로세스 우선순위 기초 2
  - 사용자 확인 시스템콜 메서드
  - 프로세스 스케줄링 알고리즘 (공평한 몫 우선순위 알고리즘)
  - [비디오](https://www.youtube.com/watch?v=2XRNun7n3io)
### 10. 병행 프로세스 1
  - [비디오](https://www.youtube.com/watch?v=ztSXkplX7C8)
### 11. 병행 프로세스 2
  - [비디오](https://www.youtube.com/watch?v=ulQlSgJvc-Q)
